...
These frequency tables were constructed using Bayesian structures for the initial and transition distributions of each model, and they can be used as input to codes such as MIT-LL for generating tracks.
...
Initial: Airspace, Altitude, Speed, Acceleration, Vertical Rate, Turn Rate.

Transition: Airspace, Altitude, Speed, Acceleration, Vertical Rate, Turn Rate, Acceleration+1 (next time step), Vertical Rate+1 (next time step), Turn Rate+1 (next time step).
